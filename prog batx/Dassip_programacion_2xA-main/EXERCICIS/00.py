...
print('BENVINGUT A LA TEVA COLECCIO DE VIDEOJOCS 🎮👾🕹️')
print( 'Selecciona una opcio del 1 al 13: ')
...
while True:
    ...
    print('10 iminar la coleccio i sortir', sep="")  
    print('11 sortir sense eliminar', sep="")  
    ...
    if option == '1':
        ...
        print('ELIMINANT ☠️☠️º')
        print('Sortinit de la coleccio, GRACIES !!!')
